        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-12">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-3 mb-6 group">
              ...
              <span className="text-2xl font-bold text-white">Megastone</span>
            </Link>
            <p className="text-blue-100 mb-6 leading-relaxed max-w-md">
              Protecting businesses from cyber threats with cutting-edge
              security solutions. Your trusted partner in cybersecurity.
            </p>
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="w-10 h-10 bg-white/10 backdrop-blur-sm rounded-lg flex items-center justify-center text-white hover:bg-white/20 hover:scale-110 transition-all duration-300"
        ...
        <div className="mt-12 pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-blue-200 text-sm">
              © {currentYear} Megastone. All rights reserved.
            </p>
